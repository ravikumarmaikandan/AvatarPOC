...
namespace AvatarPOC.Generated
{
    ...
    public class PaintAvatar
    {
        ...
        {   // Label: stroke of Max
            ...
            _patientAvatarRenderer.Cubic(104.565545f, 14.187160f, 87.261074f, 6.180996f, 73.964130f, 15.140099f);
            _patientAvatarRenderer.Cubic(13.153224f, 56.112757f, 89.440560f, 139.756456f, 122.570830f, 162.539185f);
            _patientAvatarRenderer.Cubic(143.134946f, 148.848616f, 244.902366f, 57.343149f, 173.362178f, 14.833701f);
            _patientAvatarRenderer.Cubic(158.478648f, 5.989853f, 142.508352f, 14.101746f, 125.560152f, 39.063585f);
            _patientAvatarRenderer.Close();
            _patientAvatarRenderer.Move(125.779048f, 39.212207f);
            _patientAvatarRenderer.Cubic(142.688954f, 14.306769f, 158.468658f, 6.291685f, 173.227022f, 15.061159f);
            _patientAvatarRenderer.Cubic(244.458014f, 57.386881f, 142.971994f, 148.639324f, 122.572106f, 162.320309f);
            _patientAvatarRenderer.Cubic(89.615546f, 139.555684f, 13.555250f, 56.160919f, 74.111972f, 15.359523f);
            _patientAvatarRenderer.Cubic(87.285279f, 6.483723f, 104.401840f, 14.402948f, 125.568941f, 39.223738f);
            _patientAvatarRenderer.Close();
        ...
        {   // Label: filling of Min
            ...
            _patientAvatarRenderer.Cubic(125.669600f, 61.060515f, 144.614690f, 13.741686f, 168.002930f, 24.774811f);
            _patientAvatarRenderer.Cubic(213.628830f, 46.298285f, 122.645790f, 161.602190f, 122.645790f, 161.602190f);
            _patientAvatarRenderer.Cubic(122.645790f, 161.602190f, 40.084624f, 46.050825f, 82.580313f, 24.774811f);
            _patientAvatarRenderer.Cubic(103.985870f, 14.057841f, 125.669600f, 61.060515f, 125.669600f, 61.060515f);
            //   p.close();
        ...
        {   // Label: stroke of Min
            ...
            _patientAvatarRenderer.Cubic(111.321551f, 29.643204f, 96.869306f, 17.472896f, 82.521088f, 24.656517f);
            _patientAvatarRenderer.Cubic(54.091850f, 38.889981f, 67.484348f, 84.626625f, 122.538151f, 161.679098f);
            _patientAvatarRenderer.Cubic(183.419406f, 84.796616f, 198.582651f, 39.054157f, 168.059372f, 24.655164f);
            _patientAvatarRenderer.Cubic(152.389726f, 17.263194f, 138.188914f, 29.435316f, 125.546786f, 61.011344f);
            _patientAvatarRenderer.Close();
            _patientAvatarRenderer.Move(125.792414f, 61.109686f);
            _patientAvatarRenderer.Cubic(138.410406f, 29.593942f, 152.431814f, 17.575594f, 167.946488f, 24.894458f);
            _patientAvatarRenderer.Cubic(198.257742f, 39.193430f, 183.182894f, 84.669224f, 122.541936f, 161.520242f);
            _patientAvatarRenderer.Cubic(67.725677f, 84.509268f, 54.407857f, 39.027659f, 82.639538f, 24.893105f);
            _patientAvatarRenderer.Cubic(96.832063f, 17.787433f, 111.106009f, 29.807594f, 125.549475f, 61.115932f);
            _patientAvatarRenderer.Close();
        ...
        {   // Label: filling of Time
            ...
            _patientAvatarRenderer.Cubic(113.002950f, 40.010533f, 115.976120f, 90.017506f, 125.970820f, 94.936682f);
            _patientAvatarRenderer.Cubic(129.258830f, 96.554968f, 134.848630f, 84.806947f, 138.159820f, 87.655557f);
            _patientAvatarRenderer.Line(152.681790f,101.593800f);
