...
namespace Philips.PIC.CommonControls
{
    ...
    public class PaintAvatar : PatientAvatarBase
    {
        ...
        {   // Label: Max
            ...
            path.Cubic(144.409170f, 16.465652f, 163.052550f, 52.963249f, 163.052550f, 74.763221f);
            path.Line(163.052550f, 122.765010f);
            path.Cubic(163.052550f, 129.697420f, 157.432700f, 135.317240f, 150.500330f, 135.317240f);
            path.Line(123.731260f, 135.317240f);
            path.Cubic(108.639000f, 135.317240f, 92.424681f, 123.085580f, 92.424681f, 107.993320f);
            path.Line(92.424681f, 43.851177f);
            path.Cubic(92.424681f, 28.697259f, 97.813021f, 16.465652f, 112.905280f, 16.465652f);
            path.Close();
            path.Move(8.221182f, 74.763221f);
            path.Line(8.221182f, 122.765010f);
            path.Cubic(8.248212f, 129.694580f, 13.880783f, 135.293890f, 20.810399f, 135.280240f);
            path.Line(47.567114f, 135.280240f);
            path.Cubic(62.659379f, 135.280240f, 78.886034f, 123.048580f, 78.886034f, 107.956320f);
            path.Line(78.886034f, 43.752567f);
            path.Cubic(78.861334f, 28.660303f, 73.473034f, 16.465652f, 58.380767f, 16.465652f);
            path.Cubic(26.876897f, 16.465652f, 8.221182f, 52.963249f, 8.221182f, 74.763221f);
            path.Close();
        ...
        {   // Label: Min
            ...
            path.Cubic(134.306180f, 33.292791f, 151.375990f, 59.455653f, 151.375990f, 75.082682f);
            path.Line(151.375990f, 109.492200f);
            path.Cubic(151.375990f, 114.461620f, 143.641990f, 122.631530f, 138.672580f, 122.631530f);
            path.Line(119.483520f, 122.631530f);
            path.Cubic(108.664820f, 122.631530f, 97.041741f, 109.722010f, 97.041741f, 98.903290f);
            path.Line(97.041741f, 52.923779f);
            path.Cubic(97.041741f, 42.060891f, 100.904300f, 33.292791f, 111.723020f, 33.292791f);
            path.Close();
            path.Move(22.513399f, 75.082682f);
            path.Line(22.513399f, 109.492200f);
            path.Cubic(22.532969f, 114.459580f, 27.878239f, 122.396850f, 32.845656f, 122.387060f);
            path.Line(52.025887f, 122.387060f);
            path.Cubic(62.844588f, 122.387060f, 74.476474f, 109.695480f, 74.476474f, 98.876780f);
            path.Line(74.476474f, 52.853079f);
            path.Cubic(74.458674f, 42.034374f, 70.596234f, 33.292791f, 59.777518f, 33.292791f);
            path.Cubic(37.194353f, 33.292791f, 22.513399f, 59.455653f, 22.513399f, 75.082682f);
            path.Close();
        ...
        {   // Label: Time
            ...
            path.Cubic(43.429504f, 168.347960f, 39.982704f, 154.264170f, 45.231654f, 154.313390f);
            path.Cubic(49.886914f, 154.357090f, 47.841004f, 168.278280f, 59.412444f, 169.118210f);
        ...
        {   // Label: Max
            ...
            path.Cubic(84.849782f, 64.542190f, 103.605200f, 41.642153f, 120.025080f, 49.730538f);
            path.Cubic(172.749690f, 75.702527f, 97.689319f, 131.653220f, 82.616430f, 140.033190f);
            path.Cubic(58.156036f, 126.088760f, 1.894900f, 74.950522f, 46.715292f, 49.915684f);
            path.Cubic(61.378268f, 41.725544f, 84.849782f, 64.542190f, 84.849782f, 64.542190f);
            path.Close();
        ...
        {   // Label: Min
            ...
            path.Cubic(84.849782f, 77.965255f, 98.842419f, 48.992269f, 116.116710f, 55.747774f);
            path.Cubic(149.815500f, 68.926446f, 82.616430f, 139.526210f, 82.616430f, 139.526210f);
            path.Cubic(82.616430f, 139.526210f, 21.637667f, 68.774928f, 53.024512f, 55.747774f);
            path.Cubic(68.834420f, 49.185849f, 84.849782f, 77.965255f, 84.849782f, 77.965255f);
            path.Close();
        ...
        {   // Label: Time
            ...
            path.Cubic(99.532566f, 110.730050f, 102.505740f, 160.737020f, 112.500440f, 165.656200f);
            path.Cubic(115.788450f, 167.274490f, 121.378250f, 155.526460f, 124.689440f, 158.375070f);
